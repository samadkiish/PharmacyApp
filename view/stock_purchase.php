        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Stock Purchase Managements</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="row">
                    ...
                    <div class="message"></div></div>
                                <h4 class="card-title">Stock Purchase List Table</h4>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Stock Purchase Edit / New</h5>
                                                        ...
                                                        <div class="basic-form">
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <select type="text" id="supplier_id" name="supplier_id" class="form-control" placeholder="" required="true">
</select>
                                                                    </div>
                                                                </div>
...
<script src="../js/stock_purchase.js"></script>
