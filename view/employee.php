    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Employee New/Edit </h5>
                    ...
                    <div class="container-fluid">
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Title</label>
                                    <input type="text" id="title" name="title" class="form-control" placeholder="Tile">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Salary</label>
                                    <input type="number" step="any" id="salary" name="salary" class="form-control">
                                </div>
                            </div>
